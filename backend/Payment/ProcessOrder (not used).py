...
def processOrder(productIdsAndQuantity, userId):
    print(f"products are {productIdsAndQuantity}, userId is {userId}")
    """
    ...
    if len(productIdsAndQuantity)==0:
    ...
    with conn.cursor() as cur:
        ...
        cur.execute(sql)
        print(cur.rowcount)
        for i in productIdsAndQuantity:
